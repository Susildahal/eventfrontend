    ...
    <div className="min-h-screen bg-black text-white p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-400">Events of the Century - Content Management</p>
        </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="criteria" className="space-y-6 mt-6">
              <Card className="bg-gray-900 border-gray-700">
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <CardTitle className="text-white">Criteria Items</CardTitle>
                    <CardDescription className="text-gray-400">Manage hard criteria and process steps</CardDescription>
                  </div>
            ...
            <TabsContent value="beverage" className="space-y-6 mt-6">
              <Card className="bg-gray-900 border-gray-700">
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <CardTitle className="text-white">Beverage Program Venues</CardTitle>
                    <CardDescription className="text-gray-400">Manage venue types in beverage program</CardDescription>
                  </div>
              ...
              <Card className="bg-gray-900 border-gray-700">
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="text-gray-400">Manage additional event services</CardDescription>
                  </div>
            ...
            <TabsContent value="timeline" className="space-y-6 mt-6">
              <Card className="bg-gray-900 border-gray-700">
                <CardHeader className="flex flex-row items-center justify-between">
                  <div>
                    <CardTitle className="text-white">Process Timeline</CardTitle>
                    <CardDescription className="text-gray-400">Manage typical timeline steps</CardDescription>
                  </div>
